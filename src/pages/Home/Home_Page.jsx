...
import Product_overview_img1 from './../../assets/img/product_overview/fruits.jpg'
import Product_overview_img2 from './../../assets/img/product_overview/vegetable.jpg'
import Product_overview_img3 from './../../assets/img/product_overview/dry_fruit.webp'
    ...
    <>
      ...
      <section className='section'>
        ...
        <div className="row_col-3">
          ...
          />
          <Product_overview
            title="Buy Fresh vegetable        "
            subtitle="we provide best quality of vegetable"
            image={Product_overview_img2}
          />
          <Product_overview
            title="Buy heathy Dry Fruits"
            subtitle="we provide best quality of dry fruits        "
            image={Product_overview_img3}
          />
        </div>
        <div className="row_col-3">
          <Product total_card={8} />
        </div>
      </section>
