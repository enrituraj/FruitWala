      ...
      <div className="hero">
        <div className="content">
          ...
          <div className="img_area">
            <img className='img1' src="https://www.pinclipart.com/picdir/big/564-5641142_fruits-and-vegetables-vector-png-clipart.png" alt="" />
            ...
            <img className='img3' src="https://www.freeiconspng.com/uploads/rainbow-food-vegetable-png-24.png" alt="" />
          </div>
        </div>
      </div>
    </>
