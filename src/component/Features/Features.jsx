  ...
  return (
    <div className="feature_section">
      <FeatureCard
        ...
        description="Explore a curated selection of the freshest fruits, vegetables, and premium dry fruits, handpicked to elevate your culinary experience."
      />
      <FeatureCard
        img={heart_rate}
      ...
      <FeatureCard
        ...
        description="Embrace sustainability. Fruitwala is committed to environmentally friendly practices, ensuring a positive impact on both health and the planet."
      />
      <FeatureCard
        img={restaurants}
